...
FoodItem::FoodItem(string id, string name, string category, double price, string cuisineType, int prepTime, bool isSpicy)
...
double FoodItem::calculateDiscountedPrice(double discountPercentage) const {
	...
	if (discountPercentage > 30.0) discountPercentage = 30.0;
