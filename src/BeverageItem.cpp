 ...
 */
BeverageItem::BeverageItem(string id, string name, string category,
                           double price, double volume, string beverageType,
                           bool isCarbonated)
    : MenuItem(id, name, category, price), volume(volume),
      beverageType(beverageType), isCarbonated(isCarbonated) {
  setVolume(volume);
...
//   GETTERS
// ===========
double BeverageItem::getVolume() const { return volume; }

string BeverageItem::getBeverageType() const { return beverageType; }

bool BeverageItem::getIsCarbonated() const { return isCarbonated; }
