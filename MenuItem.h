...
private:
  ...
  std::string category; // category classification: Appetizer, Main Course,
                        // Dessert, Beverage
...
public:
  /*
   * parameterized constructor, creates a menu item with the specified
   * attributes All values are validated through setters before storing them.
   */
  MenuItem(std::string id, std::string name, std::string category,
           double price);
